...
import { Platform, StyleSheet, Text, View, Alert, Button, Linking } from 'react-native';
import { WebView } from 'react-native-webview';

var WebViewAndroid = require('react-native-webview-rtc');

var SITE_URL = 'https://tryit.jssip.net';
var URL_DOMAIN = 'https://tryit.jssip.net';
...
class CallJustForTest extends Component {
...
export default CallJustForTest;